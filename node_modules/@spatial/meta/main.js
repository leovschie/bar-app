...
function segmentEach(geojson, callback) {
    flattenEach(geojson, (feature, featureIndex, multiFeatureIndex) => {
        ...
        coordReduce(feature, (previousCoords, currentCoord, coordIndex, featureIndexCoord, mutliPartIndexCoord, geometryIndex) => {
            const currentSegment = helpers.lineString([previousCoords, currentCoord], feature.properties);
...
function lineEach(geojson, callback) {
    ...
    flattenEach(geojson, (feature, featureIndex, multiFeatureIndex) => {
        ...
        case 'LineString':
            ...
            break;
        case 'Polygon':
            for (let geometryIndex = 0; geometryIndex < coords.length; geometryIndex++) {
                callback(helpers.lineString(coords[geometryIndex], feature.properties), featureIndex, multiFeatureIndex, geometryIndex);
            }
            break;
        }
    });
